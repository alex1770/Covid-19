...
parser.add_argument('-d', '--decluster',  action="store_true",                           help="Decluster assumes metadata is COG format OR stdin is in fasta format and includes virus names selected from metadata")
