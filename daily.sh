...
(
    cd VOCgrowth
    python3 uk_var_comp.py -d -f 2023-10-01 -p -b -l 'BA.2.86.1,JN.1,JN.2+JN.3' -F30 -n topfewvariants
    python3 uk_var_comp.py -d -f 2023-09-01 -l 'EG.5.1,EG.5.1.1,EG.5.1.3,EG.5.1.4,EG.5.1.6,XBB.1.16,XBB.1.16.11,XBB.1.16.15,XBB.1.16.6,FL.1.5.1,GE.1,HF.1,HK.3,HV.1,BA.2.86.1,JN.1,JG.3,JD.1.1,*,BA.2.86*,JN.*,XBB.*,XBB.1.*,XBB.1.5*,XBB.1.16*,EG.*,FL.*' -F30 -n topmanyvariants
)
