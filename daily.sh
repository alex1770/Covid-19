...
rsync -pt Traffic/trafficlevels Traffic/trafficgraph.png Traffic/trafficgraph.small.png worldometer.csv trendthr_cases.png trendthr_deaths.png trendsimple_cases.png trendsimple_deaths.png trendthr_cases.small.png trendthr_deaths.small.png trendsimple_cases.small.png trendsimple_deaths.small.png trendsimple_cases_zoom.png trendsimple_deaths_zoom.png trendsimple_cases_zoom.small.png trendsimple_deaths_zoom.small.png recent_cases.small.png recent_cases.png recent_deaths.png recent_deaths.small.png sonorous@sonorouschocolate.com:public_html/covid19/extdata
